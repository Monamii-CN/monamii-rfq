...
class MydbOperator():
    ...
    def saveRFQ(self, rfqObj):
      ...
      val = (rfqObj.rfq_title, rfqObj.rfq_quantity, rfqObj.rfq_unit, rfqObj.rfq_stars, rfqObj.rfq_open_time, rfqObj.rfq_origin, rfqObj.rfq_buyer, rfqObj.rfq_buyer_tag, rfqObj.rfq_quote, rfqObj.rfq_desc, rfqObj.rfq_link)
