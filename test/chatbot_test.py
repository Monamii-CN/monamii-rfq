...
from webhook import WebHook, is_not_null_and_blank_str, ActionCard, FeedLink, CardItem
...
class TestDingtalkChatbot(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.webhook = 'https://oapi.dingtalk.com/robot/send?access_token=f8da3ff447e780aaa9fd6aea02bff40076ec064d7d2fb01ff022182d1a05e282'
        cls.xiaoding = WebHook(cls.webhook)
    ...
    def test_send_text(self):
        """测试发送文本消息函数"""
        result = self.xiaoding.send_text(msg='test我就是小丁，小丁就是我！', is_at_all=True)
